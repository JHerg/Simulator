...
> **Neue Richtung (Juni 2026):** Einstieg direkt als **5 km Open World**
> rund um Altbaumburgweg 2. Die Story-Route (Altbaumburgweg → Stadion) wird
> als kuratierter Pfad *auf* dieser Open World gebaut — nicht umgekehrt.
...
- **Open World als Einstieg (V1.0):** Kein linearer Korridor — direkt ein
  frei befahrbares Viertel im **5 km-Radius** um Altbaumburgweg 2. Echte
  OSM-Straßen, echte Gebäude, einfach rumfahren und das Viertel wiedererkennen.
  Die Story-Route wird als optionaler Pfad durch diese Welt ergänzt. Siehe §6.9.

### 1.3 Nicht-Ziele (Scope-Disziplin)
- Kein vollständiges Köln — Grenze ist der **5 km-Radius** um Altbaumburgweg 2.
  Alles außerhalb bleibt für spätere Versionen.
...
- Radius: **5 km** → ca. 78 km² Fläche
- Umfasst: Bilderstöckchen, Bocklemünd, Vogelsang, Ossendorf, Ehrenfeld,
...
- Overpass-Abfrage: `way["highway"](around:5000, 50.9674, 6.9382)` → alle
  Straßen im 5 km-Radius
- Gebäude: `way["building"](around:5000, 50.9674, 6.9382)` → Footprints
...
- **World Partition:** 5 km-Radius in ~100 Streaming-Zellen à 500×500 m;
...
- OSM-Daten für **5 km-Radius** laden (Overpass API → GeoJSON)
...
- World Partition für das gesamte 5 km-Gebiet anlegen
...
2. **OSM-Daten laden:** Overpass-Turbo-Export für 5 km-Radius als GeoJSON/OSM.
